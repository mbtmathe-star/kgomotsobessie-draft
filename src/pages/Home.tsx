  ...
  return <>
      ...
      <section className="section-padding section-alt">
        <div className="container-custom">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{
          once: true
        }} variants={stagger} className="grid md:grid-cols-3 gap-8 mb-12">
            {[{
            icon: Users,
          ...
          once: true
            ...
            <div className="mt-8 max-w-2xl mx-auto">
              <video className="w-full rounded-lg" controls preload="metadata" poster={breakfastGallery1}>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{
          once: true
        }} variants={fadeUp} className="text-center mt-8">
            <Button asChild size="lg">
              <Link to="/services">
