...
const eventGallery = [
  { src: galleryEvent1, alt: "Breakfast workshop presentation" },
  { src: galleryEvent2, alt: "Parents and teenagers interacting" },
  { src: galleryEvent3, alt: "Speaker addressing attendees" },
  ...
  { src: galleryEvent8, alt: "Keynote presentation" },
  { src: galleryEvent9, alt: "Workshop session" },
  { src: galleryEvent10, alt: "Group discussion" },
];
      ...
      <section className="py-10 md:py-14 bg-white border-b border-border">
        <div className="container-wide">
          ...
          >
            ...
            <motion.div
              variants={fadeUp}
              className="space-y-3 text-foreground text-sm md:text-base leading-relaxed"
            >
              <p>
      ...
      <section className="py-10 md:py-14 bg-muted/30">
        <div className="container-wide">
          ...
          >
            <motion.h2
              variants={fadeUp}
              className="font-heading text-xl md:text-2xl font-bold text-foreground mb-6 text-center"
            >
              Workshop Highlights
            </motion.h2>
